<?php
	...
	$sql = "UPDATE matriculas_ficha_123_ciclos SET 
		unidade_organica = ?,
		nome_da_escola = ?,
		localidade = ?,
		ano_de_escolaridade = ?,
	...
	$stmt->bind_param(
		'ssssssiisisssssssssssiisissssisssssiissssssssssssssssssssssssssssssssssssii',
		$UNIDADE_ORGANICA, $NOME_DA_ESCOLA, $LOCALIDADE, $ANO_DE_ESCOLARIDADE, $TURMA, $CURSO, $ALUNO_NUMERO_DE_PROCESSO, // 7
		...
		$AUTORIZACAO_PROSUCESSO, $CONCORDAR_REGULAMENTO_DA_MATRICULA, $CONCORDAR_REGULAMENTO_DA_ESCOLA, $OBSERVACOES, $ESTADO, $ALUNO_NIF // 6
	);
