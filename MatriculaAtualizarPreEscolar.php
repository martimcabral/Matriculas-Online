<?php
    ...
    $NIF_ALUNO = $_POST['AlunoNIF'];
	$NIF_EE = $_POST['EENumeroDeIdentificacaoFiscal'];
	...
	$sql = "UPDATE matriculas_ficha_pre_escolar SET 
		ee_nif = ?, 
		id_escola1 = ?, 
		id_escola2 = ?, 
		id_escola3 = ?, 
	...
	if (!$stmt) {
 	...
 	$stmt->bind_param(
		'iiiiissssisissssssisssssisisssisssssisissssssssssiissssssssssssssssssssssissssssii',
		$NIF_EE, $ESCOLA_1, $ESCOLA_2, $ESCOLA_3, $ID_AZORES_ESCOLA, $ALUNO_NOME , $ALUNO_DATA_DE_NASCIMENTO, // 7
		...
		$ATL_VAI_FREQUENTAR, $ATL_ONDE, $AUTORIZACAO_DE_IMAGENS_DO_ALUNO, $CONCORDO_REGULAMENTO, $CONCORDAR_REGULAMENTO_DA_ESCOLA, // 5
		$OBSERVACOES, $ESTADO, $NIF_ALUNO // 3
	);
