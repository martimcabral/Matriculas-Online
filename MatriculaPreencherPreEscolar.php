					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div>
										<h5><b>DOCUMENTOS OBRIGATÓRIOS</b></h5>
										<p>A entrega de Documentos adicionais poderá ficar suspensa até ao início do ano letivo, a saber:</p>
										<p>✔ Cartão de Identificação Civil do Aluno</p>
										<p>✔ Cartão de Identificação do Pai, da Mãe e do Encarregado de Educação, se não for nenhum dos pais.</p>											<p>✔ Comprovativo da Vacinação do Centro de Saúde</p>
