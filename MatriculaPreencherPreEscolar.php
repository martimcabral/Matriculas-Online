    ...
    <div class="dashboard-main-wrapper">
		...
		<?php 
			if ($ENCONTROU_NAS_MATRICULAS == true) {
				echo "<form action='MatriculaAtualizarPreEscolar.php' method='POST'>";
			} else {
				echo "<form action='MatriculaNovaPreEscolar.php' method='POST'>";
			}
		?>
				...
				<div class="dashboard-short-list">
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<h5 class="card-header">ANTES DE PREENCHER LEIA COM MUITA ATENÇÃO</h5>
								<div class="card-body">
									<div>
										<h5><b>PRAZOS E PROCEDIMENTOS</b></h5>
										<p><b>Educação Pré-Escolar (1ª Matrícula)</b></p>
										<p>✔ O pedido de matrícula é apresentado na unidade orgânica da área da residência da criança, entre o dia <b>1 de Maio e o dia 16 de Junho</b></p>
										<p>✔ São admitidas as <b>crianças que perfazem três anos de idade até 15 de Setembro</b></p>
										<p>✔ A matrícula das crianças que completam três anos de idade entre 16 de Setembro e 31 de Dezembro é aceite a título condicional, sendo a
											respetiva frequência condicionada à existência de vaga no estbelecimento de educação pretendido à data do início das atividades</p>
										<p>✔ A matrícula da criança do Ensino Básico numa unidade orgânica distinta da área pedagógica correspondente à sua área de residência só é 
											aceite caso a escola de destino tenha disponibilidade para receber o aluno</p>
										<p>✔ A matrícula fica condicionada, no caso de as crianças não terem ainda o controle de esfíncter</p>
										<h5><b>IMPORTANTE SABER</b></h5>
										<p>✔ A inscrição nas Atividades de Tempos Livres <b>(A.T.L)</b> é da inteira responsabilidade dos Pais/Encarregados de Educação</p>
										<p>✔ <b>Todos os campos são de <u>preenchimento obrigatório.</u></b></p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="date" min="<?php echo date('Y')-2?>-01-01" max="<?php echo date('Y')+10?>-12-31" class="form-control" id="AlunoValidadeDoCartaoDeCidadao" name="AlunoValidadeDoCartaoDeCidadao" value="<?php echo $ALUNO_VALIDADE_CARTAO_DE_CIDADAO;?>" required>
									</div>
									<div class="form-group">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="date" min="<?php echo date('Y')-2?>-01-01" max="<?php echo date('Y')+10?>-12-31" class="form-control" name="PaiValidadeDoCartaoDeCidadao" id="PaiValidadeDoCartaoDeCidadao" value="<?php echo $PAI_VALIDADE_DO_CARTAO_DE_CIDADAO;?>" required>
									</div>
									<div class="form-group">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="date" min="<?php echo date('Y')-2?>-01-01" max="<?php echo date('Y')+10?>-12-31" class="form-control" name="MaeValidadeDoCartaoDeCidadao" id="MaeValidadeDoCartaoDeCidadao" value="<?php echo $MAE_VALIDADE_DO_CARTAO_DE_CIDADAO;?>" required>
									</div>
									<div class="form-group">
								...
								<div class="card-body">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="date" min="<?php echo date('Y')-2?>-01-01" max="<?php echo date('Y')+10?>-12-31" class="form-control" name="EEValidadeDoCartaoDeCidadao" id="EEValidadeDoCartaoDeCidadao" value="<?php echo $EE_VALIDADE_DO_CARTAO_DE_CIDADAO;?>" readonly required>
										</div>	
										<div class="form-group">
								...
								<div class="card-body">
									...
									<div class="form-group">
										<div style="display: flex; flex-direction: row">
											...
											<label style="padding: 7px; width: 100px;" for="JardimDeInfancia" class="col-form-label">Jardim de Infância</label>
										</div>
										<div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="from-group">
										<label class="col-form-label">Se sim em qual Escola?:</label>
										<select class="form-control" id="IrmaoFrequentarNucleoEscolarEmQualEscola" name="IrmaoFrequentarNucleoEscolarEmQualEscola" required>
											<option value="">-- Selecionar --</option>
											<option value="EB 2,3 de Arrifes" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB 2,3 de Arrifes') echo 'selected';?> >EB 2,3 de Arrifes</option>
											<option value="EB1/JI Cardeal Humberto de Medeiros" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI Cardeal Humberto de Medeiros') echo 'selected';?> >EB1/JI Cardeal Humberto de Medeiros</option>
											<option value="EB1/JI da Covoada" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI da Covoada') echo 'selected';?> >EB1/JI da Covoada</option>
											<option value="EB1/JI da Relva" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI da Relva') echo 'selected';?> >EB1/JI da Relva</option>
											<option value="EB1/JI do Outeiro" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI do Outeiro') echo 'selected';?> >EB1/JI do Outeiro</option>
											<option value="EB1/JI dos Milagres" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI dos Milagres') echo 'selected';?> >EB1/JI dos Milagres</option>
											<option value="EB1/JI do Engº. José Cordeiro" <?php if ($IRMAO_FREQUENCIA_ANTERIOR == 'EB1/JI do Engº. José Cordeiro') echo 'selected';?> >EB1/JI do Engº. José Cordeiro</option>
										</select>
									</div>
									<script>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input style="padding: 7px;" id="SimImagensAutorizacao" type="radio" name="ConcordoRegulamento" value="Concordo" <?php if ($CONCORDO_REGULAMENTO == "Concordo") echo 'checked';?> required>
